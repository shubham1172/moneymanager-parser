...
ASSETTOFK_COLS = ("toAssetUid", "TOASSETUID", "to_asset_id", "toAssetUID", "to_asset_uid")
MEMO_COLS = ("ZCONTENT", "MEMO", "memo", "content", "ZCOMMENT", "comment")

NAME_COLS = ("ZNAME", "NAME", "name", "title", "ZTITLE")
ASSET_NAME_COLS = ("NIC_NAME", "nic_name", "ZNICNAME", "ZNAME", "NAME", "name", "title", "ZTITLE")
UID_COLS = ("uid", "UID", "C_UID", "_id", "id", "ID", "ZUID")
BALANCE_COLS = ("ZMONEY", "AMOUNT", "amount", "balance", "ZAMOUNT")
IS_DEL_COLS = ("IS_DEL", "is_del", "C_IS_DEL", "c_is_del", "isDel", "ZISDEL", "ZISDELETED")
